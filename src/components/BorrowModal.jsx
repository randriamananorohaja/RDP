      ...
      >
        ...
        >
          ...
          <div className="flex items-start justify-between mb-5">
            <div>
              <h2 className="text-lg font-semibold text-white">Nouvel emprunt</h2>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-lg bg-slate-900 border border-slate-600
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      />
                      <span className="text-white text-sm font-medium">{bt.label}</span>
                    </div>
                    <span
          ...
          {/* Erreur */}
          {error && (
            <div className="mb-4 p-2.5 rounded-lg bg-rose-500/10 border border-rose-500/30">
          ...
          {nom.trim() && selectedType && (
            <div className="mb-4 p-2.5 rounded-lg bg-slate-900/70 border border-slate-700">
